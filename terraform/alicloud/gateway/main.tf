...
resource "alicloud_network_interface" "private_eni" {
...
resource "alicloud_network_interface_attachment" "private_eni_attachment" {
  instance_id          = module.common_gateway_instance.gateway_instance_id
  network_interface_id = alicloud_network_interface.private_eni.id
}
...
module "common_internal_default_route" {
  ...
  internal_eni_id = alicloud_network_interface.private_eni.id
}
