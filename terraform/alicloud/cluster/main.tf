...
// Private ENIs
resource "alicloud_network_interface" "member_a_private_eni" {
...
resource "alicloud_network_interface_attachment" "member_a_private_eni_attachment" {
  instance_id = alicloud_instance.member-a-instance.id
  network_interface_id = alicloud_network_interface.member_a_private_eni.id
}
resource "alicloud_network_interface" "member_b_private_eni" {
...
resource "alicloud_network_interface_attachment" "member_b_private_eni_attachment" {
  instance_id = alicloud_instance.member-b-instance.id
  network_interface_id = alicloud_network_interface.member_b_private_eni.id
}
...
module "common_internal_default_route" {
  ...
  internal_eni_id = alicloud_network_interface.member_a_private_eni.id
}

module "cluster_ram_role" {
  count = local.create_ram_role
  source = "../modules/cluster_ram_role"
